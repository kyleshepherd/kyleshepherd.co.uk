    ...
    <React.Fragment>
      ...
      <div className="workContainer">
        ...
        <Project
          ...
          projectText={`I walked past someone and saw them smile at their phone and thought to myself what they could be smiling at. I then decided to make a site to catalogue the various reasons people smile at their phone. \n Users can submit their reason(s) and also view other random reasons that have been submitted. The site is built using Svelte + Sapper and uses Firestore for the storage of reasons.`}
        ...
        <Project
          ...
          imageAlt="SOON_ Logo"
          projectText={`I'm currently working at SOON_, a London-based digital agency with a variety of international clients, as a Frontend Engineer. My role involves building components and pages for projects using Svelte or React, whilst also reviewing peers code before conducting merges and deploys.`}
        />
        <Project
