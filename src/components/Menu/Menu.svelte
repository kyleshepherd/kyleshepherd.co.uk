<script lang="ts">
  ...
  import FooterSocialLink from "../Footer/FooterSocialLink/FooterSocialLink.svelte";
...
>
  <div class="container w-full flex flex-col flex-1">
    <div class="flex justify-end">
      <button
        type="button"
        title="Toggle Menu"
        class="text-light transition-colors hover:text-green"
        on:click={closeMenu}
      >
  ...
  <div class="mb-3 flex justify-center gap-4 sm:mb-4">
    <FooterSocialLink hoverGreen url="https://github.com/kyleshepherd">
      <svg
        stroke="currentColor"
        fill="currentColor"
        stroke-width="0"
    ...
    <FooterSocialLink hoverGreen url="https://twitter.com/kyleshepherddev">
      <svg
        stroke="currentColor"
        fill="currentColor"
        stroke-width="0"
