...
export const projects: Project[] = [
	{
		...
		body: "This project was a large-scale eCommerce transformation at SOON_, built on Shopify and powered by our custom in-house platform, SOON_CMS.<br/><br/>I helped deliver key areas of the site, including the product detail page and static pages. One of the more interesting challenges came with the PDP, where a significant amount of product data needed to be displayed in the Details Tray. To handle this efficiently, I used our Go-based GraphQL API to structure and streamline the data from Shopify before consuming it within the SvelteKit frontend.",
