<div class="component-padding mt-12 xl:mb-4">
	<p class="max-w-prose text-lg xl:text-xl 2xl:text-2xl">
		...
		White Cube and Belstaff. I specialise in Go and modern JavaScript frameworks like Svelte and
		React.<br /><br />
		Currently, I work at
		<a
		...
		infrastructure, with deployments to Google Cloud Platform using tools like Terraform, and
		Kubernetes.<br /><br />
